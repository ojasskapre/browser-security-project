...
button_link_keywords = ['agree', 'accept', 'ok', 'continue', 'consent', 'decline', 'reject', 'no thanks', 'settings', 'notice', 'got it', 'privacy', 'allow', 'deny', 'allow selection',
                        'do not sell', 'customize', 'preferences', 'opt-out', 'opt-in', 'accept all', 'no, manage settings', 'política', 'privacidade', 'prosseguir', 'куки', 'принять', 'отказаться', 'отклонить']

banner_attributes_keywords = ['banner', 'consent', 'Consent', 'cookie-banner', 'cookie', 'gdpr',
                              'Cookie', 'Banner', 'notice', 'privacy', 'data', 'preferences', 'tracking']
